...
export default function BioSection() {
    ...
    return (
      <section
        className="h-screen bg-darkShade w-full flex flex-col items-start"
        ref={ref}
      >
        <motion.div
        ...
        >
          <span className="text-7xl font-bold font-baskerville text-lightShade">
            Generic Title Header
          </span>
        </motion.div>
        <motion.div
          className="w-1/2 ml-48 mb-32"
          style={{
              transform: isInView ? "none" : "translateX(-200px)",
              opacity: isInView ? 1 : 0,
              transition: "all 0.9s cubic-bezier(0.17, 0.55, 0.55, 1) 0.5s",
        ...
        >
          <span className="font-sans text-2xl font-semibold text-lightShade">
